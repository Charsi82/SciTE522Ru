...
public:
	...
	const char* OnSendEditor(Scintilla::Message, unsigned int, const char*) override; //!-add-[OnSendEditor]
	const char* OnSendEditor(Scintilla::Message, unsigned int, long) override; //!-add-[OnSendEditor]
