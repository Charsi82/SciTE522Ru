...
public:
	...
	virtual const char* OnSendEditor(Scintilla::Message, unsigned int, const char*) { return 0; } //!-add-[OnSendEditor]
	virtual const char* OnSendEditor(Scintilla::Message, unsigned int, long) { return 0; } //!-add-[OnSendEditor]
#endif
#ifdef RB_ONTABMOVE
